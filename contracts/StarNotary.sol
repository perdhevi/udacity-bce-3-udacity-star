...
contract StarNotary is ERC721Full {
    ...
    //     return 'UST';
    // }
    constructor()  ERC721Full("Udacity Star", "UST") public {}
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require ((ownerAddress1 == msg.sender) || (ownerAddress2 == msg.sender), 'You must be of the transfer party');
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId)==msg.sender,'You must be the owner of this star');

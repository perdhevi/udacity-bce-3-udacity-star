...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('Orion 1 Star!', starId1, {from: accounts[0]});
    await instance.createStar('Orion 2 Star!', starId2, {from: accounts[1]});
...
it('lets a user transfer a star', async() => {
    ...
    let starId = 9;
    let instance = await StarNotary.deployed();
    await instance.createStar('Orions Belt', starId, {from: accounts[0]});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(starName, 'Awesome Star 6');
});